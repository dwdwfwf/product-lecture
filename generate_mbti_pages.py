...
mbti_data = {
    "INTJ": {
        "name": "용의주도한 전략가",
        "description": "INTJ는 상상력이 풍부하고 전략적인 사색가로, 모든 것 뒤에 숨겨진 패턴을 파악하는 데 능숙합니다. 독립적이고 결단력이 있으며, 높은 지적 호기심을 바탕으로 복잡한 문제 해결에 탁월한 능력을 발휘합니다. 지식을 끊임없이 탐구하며, 목표 달성을 위한 혁신적인 해결책을 찾는 데 주력합니다.",
    ...
    "INTP": {
        "name": "논리적인 사색가",
        "description": "INTP는 끊임없이 지식을 탐구하고 분석하며, 복잡한 문제에 대한 논리적인 해결책을 찾는 데 즐거움을 느낍니다. 이들은 조용하고 사색적이지만, 내면에는 아이디어와 가능성으로 가득 찬 세상을 품고 있습니다. 비판적 사고와 뛰어난 분석 능력을 바탕으로 혁신적인 이론을 제시하는 데 능합니다.",
    ...
    "ENTJ": {
        "name": "대담한 통솔자",
        "description": "ENTJ는 타고난 리더로, 비전을 제시하고 목표를 향해 사람들을 이끄는 데 탁월한 능력을 가지고 있습니다. 이들은 강한 의지와 결단력을 바탕으로 어떤 어려움도 극복하며, 효율성과 생산성을 중요하게 생각합니다. 논리적이고 체계적인 사고를 통해 복잡한 문제를 해결하고 조직을 성공으로 이끌어갑니다.",
    ...
    "ENTP": {
        "name": "논쟁을 즐기는 변론가",
        "description": "ENTP는 똑똑하고 호기심이 많으며, 새로운 아이디어와 도전을 즐기는 혁신가입니다. 이들은 뛰어난 논리력과 언변으로 어떤 주제에 대해서도 열정적으로 토론하며, 고정관념을 깨고 새로운 가능성을 탐색하는 데 능합니다. 틀에 얽매이지 않는 자유로운 사고방식으로 항상 새로운 것을 추구합니다.",
    ...
    "INFJ": {
        "name": "선의의 옹호자",
        "description": "INFJ는 통찰력 있고 신비로운 유형으로, 타인의 감정을 깊이 이해하고 세상을 더 나은 곳으로 만들고자 하는 강한 열망을 가지고 있습니다. 이들은 조용하고 내향적이지만, 내면에는 확고한 신념과 이상을 품고 있습니다. 복잡한 인간 관계와 사회 문제에 깊은 관심을 가지며, 영감을 통해 타인에게 긍정적인 영향을 미칩니다.",
    ...
    "ENFJ": {
        "name": "정의로운 사회운동가",
        "description": "ENFJ는 따뜻하고 카리스마 넘치는 리더로, 사람들의 잠재력을 끌어내고 공동체를 이끄는 데 능숙합니다. 이들은 뛰어난 공감 능력과 의사소통 능력을 바탕으로 타인과 깊은 관계를 맺으며, 세상을 더 나은 곳으로 만들고자 하는 강한 열망을 가지고 있습니다. 긍정적인 영향력을 통해 사람들에게 영감을 주고 변화를 만들어냅니다.",
    ...
    "ENFP": {
        "name": "재기발랄한 활동가",
        "description": "ENFP는 열정적이고 창의적이며, 새로운 가능성을 탐색하고 사람들과 깊은 관계를 맺는 것을 즐깁니다. 이들은 밝고 긍정적인 에너지로 주변을 활기차게 만들며, 뛰어난 상상력과 직관을 바탕으로 독창적인 아이디어를 제시합니다. 자유롭고 즉흥적인 삶을 추구하며, 세상을 더 재미있고 의미 있는 곳으로 만들고자 합니다.",
    ...
    "ISTJ": {
        "name": "청렴결백한 논리주의자",
        "description": "ISTJ는 책임감이 강하고 현실적인 유형으로, 신뢰할 수 있고 체계적인 방식으로 주어진 임무를 수행합니다. 이들은 전통과 규칙을 중요하게 생각하며, 세부 사항에 주의를 기울이고 실용적인 해결책을 찾는 데 능합니다. 겉으로는 조용하고 진지해 보이지만, 내면에는 강한 의무감과 헌신을 가지고 있습니다.",
    ...
    "ISFJ": {
        "name": "용감한 수호자",
        "description": "ISFJ는 따뜻하고 헌신적이며, 주변 사람들을 보호하고 돕는 데 최선을 다합니다. 이들은 책임감이 강하고 성실하며, 세부 사항에 주의를 기울여 안정적이고 조화로운 환경을 만듭니다. 겉으로는 조용하고 겸손해 보이지만, 내면에는 강한 의지와 배려심을 가지고 있습니다.",
    ...
    "ESTJ": {
        "name": "엄격한 관리자",
        "description": "ESTJ는 실용적이고 체계적이며, 규칙과 질서를 중요하게 생각하여 조직을 효율적으로 관리하고 이끌어갑니다. 이들은 책임감이 강하고 솔직하며, 현실적인 목표를 설정하고 이를 달성하기 위해 꾸준히 노력합니다. 뛰어난 추진력과 리더십으로 어떤 상황에서도 안정적인 결과를 만들어냅니다.",
    ...
    "ESFJ": {
        "name": "사교적인 외교관",
        "description": "ESFJ는 따뜻하고 사교적이며, 주변 사람들과의 조화로운 관계를 중요하게 생각합니다. 이들은 뛰어난 공감 능력과 친화력을 바탕으로 사람들에게 편안함을 주며, 공동체에 봉사하고 타인을 돕는 데 기쁨을 느낍니다. 책임감이 강하고 배려심이 깊어 어디에서나 환영받는 존재입니다.",
    ...
    "ISTP": {
        "name": "만능 재주꾼",
        "description": "ISTP는 호기심 많고 실용적인 유형으로, 주변 세상을 탐색하고 직접 손으로 문제를 해결하는 것을 즐깁니다. 이들은 조용하고 관찰력이 뛰어나며, 논리적이고 객관적인 사고를 통해 효율적인 해결책을 찾아냅니다. 자유롭고 즉흥적인 삶을 추구하며, 새로운 기술과 경험에 대한 탐구심이 강합니다.",
    ...
    "ISFP": {
        "name": "호기심 많은 예술가",
        "description": "ISFP는 따뜻하고 겸손하며, 자신의 내면세계와 아름다움을 추구하는 예술가입니다. 이들은 자유롭고 즉흥적인 삶을 즐기며, 현재의 순간을 소중히 여깁니다. 뛰어난 미적 감각과 감수성을 바탕으로 예술적인 표현에 능하며, 타인의 감정을 깊이 이해하고 공감하는 능력이 뛰어납니다.",
        ...
        "pros": [
            ...
            "공감 능력: 타인의 감정을 깊이 이해하고 공감하는 능력이 뛰어납s.",
    ...
    "ESTP": {
        "name": "모험을 즐기는 사업가",
        "description": "ESTP는 에너지 넘치고 즉흥적이며, 현재의 순간을 즐기고 새로운 경험에 도전하는 것을 좋아합니다. 이들은 현실적인 문제 해결에 능숙하고, 뛰어난 관찰력과 빠른 판단력으로 어떤 상황에서도 유연하게 대처합니다. 사람들과 어울리는 것을 즐기며, 유머러스하고 매력적인 태도로 주변을 활기차게 만듭니다.",
    ...
    "ESFP": {
        "name": "자유로운 연예인",
        "description": "ESFP는 사교적이고 활기차며, 주변 사람들을 즐겁게 하고 현재의 순간을 만끽하는 것을 좋아합니다. 이들은 뛰어난 유머 감각과 친화력을 바탕으로 사람들과 쉽게 어울리며, 즉흥적이고 자유로운 삶을 추구합니다. 따뜻하고 관대하며, 타인의 필요를 잘 파악하고 돕는 데 기쁨을 느낍니다.",
    ...
    "INFP": {
        "name": "열정적인 중재자",
        "description": "INFP는 이상주의적이고 창의적인 성향을 가진 사람들로, 자신의 가치관과 신념에 따라 살아갑니다. 이들은 깊은 감수성과 공감 능력을 바탕으로 다른 사람들을 돕고자 하는 열망이 강하며, 세상에 긍정적인 영향을 미치고 싶어 합니다. 겉으로는 조용하고 수줍어 보일 수 있지만, 내면에는 강렬한 열정과 불꽃을 품고 있습니다.",
...
<body>
    ...
    <main class="result-page">
        <section class="mbti-type-intro">
            <h2>{mbti_type}: {data['name']} (The Architect)</h2>
        ...
        <section class="mbti-jobs">
            <h3>추천 직업</h3>
            <p>{mbti_type}의 창의성과 공감 능력을 발휘할 수 있는 직업이 잘 맞습니다.</p>
            <ul>
...
for mbti_type, data in mbti_data.items():
    if mbti_type in ["INFP", "INTJ"]: # Skip the ones already created
        continue
